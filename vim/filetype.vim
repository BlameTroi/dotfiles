...
" txb--------------------------------------
" the checks for vb files in the default
" don't work if you don't want *.bas to be a
" generic 'basic' type. Overriden. If anyone
" knows a better way to do this, please let
" me know. Troy Brumley.
" txb---------------------------------------
